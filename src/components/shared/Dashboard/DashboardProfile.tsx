                    ...
                    isSuccess ?
                        <div className='grid grid-cols-1 md:grid-cols-5 gap-x-5 gap-y-5 md:gap-y-0'>
                            <div className='md:col-span-2 bg-[#232323] w-full flex flex-col justify-center items-center py-12 px-5'>
                                ...
                                <Link href={`/${data?.data?.role}/dashboard/settings`} className='text-lg font-satoshi text-secondary font-medium underline underline-offset-4 decoration-1'>Edit Profile</Link>
                            </div>
                            ...
                            <div className='md:col-span-3 bg-[#232323] w-full flex flex-col justify-center items-center py-12 px-5'>
                                <section className='space-y-4'>
                                    ...
                                    <Link href={`/${data?.data?.role}/dashboard/settings`} className='text-lg font-satoshi text-secondary font-medium underline underline-offset-4 decoration-1'>Edit Address</Link>
                                </section>
                            </div>
                        </div> : <></>
            }
